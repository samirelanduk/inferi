...
The `GitHub issue
tracker <https://github.com/samirelanduk/inferi/issues>`__ is the place
...
The first step is to fork the inferi repository to your own GitHub
...
clone your new copy of inferi to your local machine, and to do this
you simply enter ``clone https://github.com/YOUR_USERNAME/inferi`` at
...
An ideal pull request for inferi is one that either adds a function (or
...
If your pull request modifies large parts of inferi, changes the way the
...
If a function doesn't have tests, the function doesn't work. inferi has
...
.. code:: self.assertEqual(distance_between([0, 0], [3, 4]), 5)
